    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            {
              name: 'providersCreation',
              path: 'providersCreation',
              component: lazyLoading('entities/providers/providersCreation'),
              meta: {
                wikiLink: ''
              }
            },
            {
              name: 'providersList',
              path: 'providersList',
              component: lazyLoading('entities/providers/providersList'),
              meta: {
                wikiLink: ''
              }
            }
